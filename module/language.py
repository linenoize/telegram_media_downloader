...
translations = {
    ...
    "Resuming retries for channel": [
        "正在恢复频道重试",
        "Возобновление повторных попыток для канала",
        "Відновлення повторних спроб для каналу",
    ],
    "files": ["文件", "файлов", "файлів"],
    "batches": ["批次", "пакетов", "пакетів"],
    "Continuing now": ["正在继续", "Продолжаем", "Продовжуємо"],
    "See website for list": ["请在网站查看列表", "Список на сайте", "Список на сайті"],
    "Failed to send retry notification to admin": [
        "向管理员发送重试通知失败",
        "Не удалось отправить уведомление о повторе администратору",
        "Не вдалося надіслати сповіщення про повтор адміністратору",
    ],
    ...
    "Connection failed after 3 retries, download skipped.": [
        "重试3次后连接失败，跳过下载。",
        "Соединение не удалось после 3 попыток, загрузка пропущена.",
        "З'єднання не вдалося після 3 спроб, завантаження пропущено.",
    ],
    # Cleanup related translations
    "Cleanup manager started": [
        "清理管理器已启动",
        "Менеджер очистки запущен",
        "Менеджер очищення запущено",
    ],
    "No downloads for": [
        "没有下载",
        "Нет загрузок в течение",
        "Немає завантажень протягом",
    ],
    "hours": ["小时", "часов", "годин"],
    "starting cleanup": ["开始清理", "начинается очистка", "починається очищення"],
    "Cleanup already running, skipping": [
        "清理已在运行，跳过",
        "Очистка уже выполняется, пропуск",
        "Очищення вже виконується, пропуск",
    ],
    "Starting cleanup process": [
        "开始清理过程",
        "Начало процесса очистки",
        "Початок процесу очищення",
    ],
    "Error cleaning up chat": [
        "清理聊天时出错",
        "Ошибка при очистке чата",
        "Помилка при очищенні чату",
    ],
    "Error cleaning up bot messages in chat": [
        "清理聊天中的机器人消息时出错",
        "Ошибка при очистке сообщений бота в чате",
        "Помилка при очищенні повідомлень бота в чаті",
    ],
    "Cleanup completed": ["清理完成", "Очистка завершена", "Очищення завершено"],
    "Deleted": ["已删除", "Удалено", "Видалено"],
    "Logged skipped items": [
        "已记录跳过的项目",
        "Зарегистрированные пропущенные элементы",
        "Зареєстровані пропущені елементи",
    ],
    "Duration": ["持续时间", "Длительность", "Тривалість"],
    "Error during cleanup": [
        "清理期间出错",
        "Ошибка во время очистки",
        "Помилка під час очищення",
    ],
    "already-downloaded messages from chat": [
        "从聊天中已下载的消息",
        "уже скачанных сообщений из чата",
        "вже завантажених повідомлень з чату",
    ],
    "Error deleting message batch": [
        "删除消息批次时出错",
        "Ошибка при удалении пакета сообщений",
        "Помилка при видаленні пакета повідомлень",
    ],
    "Error in cleanup for chat": [
        "清理聊天时出错",
        "Ошибка при очистке чата",
        "Помилка при очищенні чату",
    ],
    "bot status messages from chat": [
        "聊天中的机器人状态消息",
        "сообщений о статусе бота из чата",
        "повідомлень про статус бота з чату",
    ],
    "Error deleting bot messages": [
        "删除机器人消息时出错",
        "Ошибка при удалении сообщений бота",
        "Помилка при видаленні повідомлень бота",
    ],
    "Error cleaning up bot messages": [
        "清理机器人消息时出错",
        "Ошибка при очистке сообщений бота",
        "Помилка при очищенні повідомлень бота",
    ],
    "Logged": ["已记录", "Зарегистрировано", "Зареєстровано"],
    "skipped items to": [
        "跳过的项目到",
        "пропущенных элементов в",
        "пропущених елементів в",
    ],
    "Error logging skipped items": [
        "记录跳过的项目时出错",
        "Ошибка при регистрации пропущенных элементов",
        "Помилка при реєстрації пропущених елементів",
    ],
    "Cleanup manager stopped": [
        "清理管理器已停止",
        "Менеджер очистки остановлен",
        "Менеджер очищення зупинено",
    ],
    "Error in cleanup check": [
        "检查清理时出错",
        "Ошибка при проверке очистки",
        "Помилка при перевірці очищення",
    ],
    "Cleanup manager enabled": [
        "清理管理器已启用",
        "Менеджер очистки включен",
        "Менеджер очищення увімкнено",
    ],
    "will run after": ["将在", "запустится через", "запуститься через"],
    "hours of inactivity": [
        "小时的不活动后运行",
        "часов бездействия",
        "годин бездіяльності",
